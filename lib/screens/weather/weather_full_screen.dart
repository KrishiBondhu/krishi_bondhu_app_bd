...
// --- YOUR 3 CORRECT IMPORTS ---
// 1. For your API Key
import '../../utils/constants.dart';
// 2. For your Detail Screen
import 'weather_detail_screen.dart';
// 3. For your Icon function
...
class _WeatherForecastScreenState extends State<WeatherForecastScreen> {
  ...
  final String _apiKey = kOpenWeatherApiKey; // <-- This will now work
  ...
  Future<void> _fetchWeatherForCity(String city) async {
    ...
    try {
      ...
      // --- (FIX FOR SUNRISE/SUNSET BUG) ---
      final forecastJson = json.decode(forecastResponse.body);
      final forecastList = (forecastJson['list'] as List);
      final cityData = (forecastJson['city'] as Map<String, dynamic>);

      // Pass BOTH the list and the city data to the processing function
      final processedDaily = _processDailyForecast(forecastList, cityData);
      // --- (END FIX) ---

      setState(() {
        _currentWeatherData = json.decode(currentResponse.body);
        _forecastData = forecastJson;
        _dailyForecast = processedDaily;
  ...
  // --- (FIX FOR SUNRISE/SUNSET BUG) ---
  // We now accept 'cityData' as a parameter
  List<Map<String, dynamic>> _processDailyForecast(
      List forecastList, Map<String, dynamic> cityData) {
    // --- (END FIX) ---
    final dailyData = <String, Map<String, dynamic>>{};

    // Get sunrise/sunset ONCE from the cityData
    final sunrise = cityData['sunrise'];
    final sunset = cityData['sunset'];
    ...
    for (final item in forecastList) {
      ...
      if (!dailyData.containsKey(dayKey)) {
        ...
        dailyData[dayKey] = {
          ...
          'sunrise': sunrise, // <-- Use the value
          'sunset': sunset, // <-- Use the value
          ...
          Row(
            ...
            children: [
              Icon(getWeatherIcon(code),
                  size: 90, color: Colors.white), // <-- This will now work
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Icon(getWeatherIcon(code), // <-- This will now work
                    size: 32,
                    color: index == 0
                        ? Colors.white
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => WeatherDetailScreen(
                        dailyItem: item))); // <-- This will now work
          },
          child: Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
